...
@section('content')
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form class="" action="{{ route('data-lokasi.store') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="name">Desa</label>
                                <input type="text" class="form-control" id="name" name="village" value="s">
                            </div>
                            <div class="form-group">
    ...
    <script>
        ...
        // Deklarasikan variabel input di luar event handler
